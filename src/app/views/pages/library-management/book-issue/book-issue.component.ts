...
export class BookIssueComponent implements OnInit {
  ...
  getAllIssueBooks() {
    this.apiService.bookIssueService.getAllIssueBook().subscribe(res => {
      this.allIssueBooks = res;
      console.log("All Issued Books", this.allIssueBooks);
  ...
  onSave() {
    if (!this.isOnEdit) {
      this.apiService.bookIssueService.createIssueBook(this.addIssueBookForm.value).subscribe((res: any) => {
        ...
        this.getAllIssueBooks();
        this.isVisible = false;
        this.notification.create("success", "Success", "Issued Books Added Successfully")
        this.isVisible = false;
      }, (err) => {
        this.isVisible = false;
      ...
      this.apiService.bookIssueService.updateIssueBook(this.addIssueBookForm.value).subscribe((res: any) => {
        ...
        this.getAllIssueBooks();
        this.isVisible = false;
        this.notification.create("success", "Success", "Issued Books Updated Successfully")
      }, (err) => {
        this.isVisible = false;
  ...
  editRecord(id) {
    ...
    this.apiService.bookIssueService.getIssueBookById(id).subscribe((res: any) => {
      ...
      console.log("Single Issued Books Record", this.singleBookIssue)
      this.addIssueBookForm.addControl('IssueID', new FormControl(id));
      this.addIssueBookForm.patchValue(this.singleBookIssue)
    })
  }
