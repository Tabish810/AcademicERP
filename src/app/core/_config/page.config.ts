export class PageConfig {
	public defaults: any = {
		...
		'student_management': {
			...
			assign_class: {
				page: { title: 'Assign Class', desc: '' }
			},
			parent_info: {
				page: { title: 'Parent Information', desc: '' }
			},
			contact_info: {
				page: { title: 'Contact Information', desc: '' }
			}
		},
		'accounts_management': {
			submit_fess: {
				page: { title: 'Submit Fess', desc: '' }
			},
			fees_discount: {
			...
			fees_template: {
				page: { title: 'Fees Template', desc: '' }
			},
			promote_student: {
				page: { title: 'Promote Student', desc: '' }
			}
		},
		'general_setup': {
			institutes: {
				page: { title: 'Institutes', desc: '' }
			},
			city: {
				page: { title: 'City', desc: '' }
			},
			state: {
				page: { title: 'State', desc: '' }
			},
			country: {
				page: { title: 'Country', desc: '' }
			}
		},
		builder: {
		...
		wizard: {
			'Class': { page: { title: 'Class', desc: '' } },
			'wizard-2': { page: { title: 'Class', desc: '' } },
